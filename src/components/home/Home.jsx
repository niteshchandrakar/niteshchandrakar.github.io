...
const Home = () => {
    ...
    return (
        <section className={styles.home_section} id="home">
            <div className={styles.home__maindiv}>
                {/* social links div  */}
                {/* <div>
                    <SocialLinks />
                </div> */}

                <div className={styles.home__second_flex}>
                    {/* image div  */}
                    <div className={styles.home__imagediv}>
{/* <img src={profile}/> */}
                    </div>

                    {/* data div  */}
                    <div className={styles.home__data_div}>

                        <h1 className={styles.hone__mynametext}>Nitesh Chandrakar
                            <svg
                                width="36"
                                height="36"
                                viewBox="0 0 48 48"
                        ...
                        <p>I love to make projects which are helpful for masses and serve as a great helpful entity.</p>

                        <div className={styles.home__button}>
                            <a href='#contact'>Say Hello <i className="uil uil-message"></i></a>
