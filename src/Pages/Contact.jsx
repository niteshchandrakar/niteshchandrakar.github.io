        ...
        <Flex display={["none" , "none" , "none" ,"flex" ,"flex"]} w="30%" justifyContent={"center"} alignItems="center" bg="">
          <Box > 
            <a href="">
              ...
              <Text fontSize={"25px"} color="gray">+91 9754601089</Text>
            ...
            <a href="">
              ...
              <Text fontSize={"25px"} color="gray">niteshchandrakar2@gmail.com</Text>
             
              </Box>
            </a>
            <a href="https://github.com/niteshchandrakar">
              <Box display={"flex"} alignItems="center"  marginBottom={"10%"}   justifyContent={"space-between"} bg=""> 
              <img  width="50px"  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTYiBwe7URF5iyjMW20qp4IvMNvys8-tGb_-A&usqp=CAU" alt="" /><Text fontSize={"25px"} color="gray">nitesh-chandrakar</Text>
              </Box>
            </a>
            <a href="https://www.linkedin.com/in/nitesh-chandrakar-9a94ab242/" fontSize="50px">
              <Box display={"flex"} alignItems="center"  marginBottom={"15%"}  justifyContent={"space-between"} bg=""> 
              <img  width="50px"  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT2RYeN56EvozwyyxYGDw4dTu-pbUZyNxnF93zSLUcOlQ&s" alt="" /><Text fontSize={"25px"} color="gray">Nitesh Chandrakar</Text>
              </Box>
            </a>
